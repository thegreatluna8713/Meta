...
const transform13 = new Transform({
  position: new Vector3(8.5, 2.5, 15.5),
...
const transform15 = new Transform({
  position: new Vector3(5, 12.5, 0.5),
  rotation: new Quaternion(0, 0, 0, 1),
  scale: new Vector3(3.375, 2.53125, 1)
})
...
const transform16 = new Transform({
  position: new Vector3(4.5, 12, 15.5),
  rotation: new Quaternion(-5.67359905191407e-15, 1, -1.1920926823449918e-7, 0),
  scale: new Vector3(3.375, 2.53125, 1)
})
...
const transform17 = new Transform({
  position: new Vector3(11, 12, 15.5),
  rotation: new Quaternion(-5.67359905191407e-15, 1, -1.1920926823449918e-7, 0),
  scale: new Vector3(3.375, 2.53125, 1)
})
...
const transform18 = new Transform({
  position: new Vector3(12, 12.5, 0.5),
...
script1.spawn(videoStream, {"startOn":true,"onClickText":"Play video","volume":1,"onClick":[{"entityName":"videoStream","actionId":"toggle","values":{}}],"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/_DSF4986.jpg","customStation":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/FB_1.mp4","onActivate":[{"entityName":"videoStream","actionId":"activate","values":{}}],"station":"https://theuniverse.club/live/genesisplaza/index.m3u8"}, createChannel(channelId, videoStream, channelBus))
...
script4.spawn(imageFromURL, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/_DSF5040.jpg"}, createChannel(channelId, imageFromURL, channelBus))
script4.spawn(imageFromURL2, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/_DSF4969.jpg"}, createChannel(channelId, imageFromURL2, channelBus))
script4.spawn(imageFromURL3, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/_DSF4943.jpg"}, createChannel(channelId, imageFromURL3, channelBus))
script4.spawn(imageFromURL4, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/_DSF4984.jpg"}, createChannel(channelId, imageFromURL4, channelBus))
script4.spawn(imageFromURL5, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/_DSF5013.jpg"}, createChannel(channelId, imageFromURL5, channelBus))
script4.spawn(imageFromURL6, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/_DSF4947.jpg"}, createChannel(channelId, imageFromURL6, channelBus))
script4.spawn(imageFromURL7, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/_DSF4953.jpg"}, createChannel(channelId, imageFromURL7, channelBus))
...
script4.spawn(imageFromURL9, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/8%20copy.jpg"}, createChannel(channelId, imageFromURL9, channelBus))
script4.spawn(imageFromURL10, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/Handbag%20QR%20Code.jpg"}, createChannel(channelId, imageFromURL10, channelBus))
script4.spawn(imageFromURL11, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/Necklace%20with%20QR%20code.jpg"}, createChannel(channelId, imageFromURL11, channelBus))
script4.spawn(imageFromURL12, {"image":"https://github.com/thegreatluna8713/Meta/blob/545c554492e375797888e34958b52b811bd743b2/9%20copy.jpg"}, createChannel(channelId, imageFromURL12, channelBus))
